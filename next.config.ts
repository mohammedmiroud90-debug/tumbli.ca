...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    remotePatterns: [{ protocol: "http", hostname: "backendweb.eollinea.com", pathname: "/parse/files/**" }, { protocol: "https", hostname: "a-us.storyblok.com", pathname: "/f/**" }, { protocol: "https", hostname: "undergrad.stanford.edu", pathname: "/**" }, { protocol: "https", hostname: "founder.brintiel.com", pathname: "/static/images/**" }],
  },
